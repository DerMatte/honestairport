...
- If connecting from B to C, ride **one stop forward** on the train — do not go via Concourse A.
...
- RTD A Line to Union Station costs **$10.00** (Airport Day Pass) and runs every 15–30 min; fastest public option.
