...
- If connecting from B to C, board the **AGTS train directly** at the Concourse B station — the loop serves B and C adjacent stops in under **2 min** ([DEN facilities](https://www.flydenver.com/about-den/facilities/)).
