...
quickFacts:
  - "Terminals 1 and 2 connected by free shuttle bus (10-15 min)"
  - "Primary hub for China Eastern Airlines and Spring Airlines"
  - "Maglev train reaches Longyang Road in 8 minutes"
  - "International arrivals require 30-60 min immigration at peak"
  - "Metro Line 2 runs to downtown Shanghai in ~60 min"
bentoTips:
  - category: "timing"
    label: "Timing"
    title: "Arrive 3 hours early for international flights"
    summary: "Security and immigration queues regularly exceed 90 minutes."
    detail: "Avoid 7-10 a.m. and 5-8 p.m. peaks; domestic flights can use 2 hours."
  - category: "terminal"
    label: "Transfers"
    title: "Use the free shuttle between T1 and T2"
    summary: "Buses run every 10 minutes; do not walk the 2 km perimeter road."
    detail: "Works best when you have at least 45 minutes; avoid during heavy rain."
  - category: "food"
    label: "Food & quiet"
    title: "Head to T2 Level 4 for local chains"
    summary: "Nanxiang Steamed Bun and Din Tai Fung outlets open until 10 p.m."
    detail: "T1 has fewer options after security; buy water before clearing immigration."
  - category: "status"
    label: "Live checks"
...
- **Cathay Pacific Lounge** in T2 is the strongest paid option for Star Alliance passengers.
...
- https://www.shanghaiairport.com/
- https://www.shmetro.com/
- https://www.shanghaiairport.com/pudongair.html
