...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane — check live wait times; BER Runway slot booking ended **26 May 2026** ([BER security update](https://ber.berlin-airport.de/de/news/2026-05-21-anpassung-siko.html)).
...
- **BER Runway discontinued:** Slot booking for the legacy Runway lanes ended **26 May 2026** — use CT lanes (liquids up to **2 L** and electronics stay in bag) and follow live wait times on the BER app or terminal monitors.
...
- Showers cost **€10** (towel and shampoo included, card only) on arrivals level **E0** ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)); lounge showers also available for a fee.

## Ground Transport & Parking
- FEX airport express is fastest to Hauptbahnhof (**~23 min** from Berlin Hbf since Dec 2025; every **15 min**) — same **ABC €5.00** VBB fare as S-Bahn ([VBB BER](https://www.vbb.de/en/driving-information/ber-airport)).
- S-Bahn lines **S9** and **S45** use the same **ABC €5.00** ticket and run more frequently off-peak.
