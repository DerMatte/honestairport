...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane; compare live wait times on the BER app before committing to any single checkpoint.
...
- **BER Runway ended 26 May 2026:** Slot booking is discontinued — follow live CT-lane wait times on the BER app or terminal monitors instead ([BER security update](https://ber.berlin-airport.de/en/news/2026-05-21-anpassung-siko.html)).
...
- Showers cost **€10** on arrivals level E0 (card only — no cash) and include a towel and shampoo ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- FEX airport express train is fastest to Hauptbahnhof (**~23 min**) on the same route as RE trains; any airport↔city trip needs a **VBB ABC ticket (€5.00 in 2026)** valid on FEX, RE, and S-Bahn.
- S-Bahn lines **S9** and **S85** (S45 discontinued Dec 2025) also reach central Berlin on the same ABC fare.
