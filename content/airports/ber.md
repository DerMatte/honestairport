...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane; on busy weekdays it often beats the general CT queues, but dynamic Prio lanes can still back up at peak.
...
- Since CT lanes rolled out and **BER Runway slot booking ended 26 May 2026**, follow live wait times on the BER app instead of pre-booking a security window — Prio/Fast Lane can beat general queues on some weekday middays but backs up at peak (verify on monitors).
...
- Showers cost **€10** on level **E0** (left of Arrivals 2); towel and shampoo included — **card only**, no cash ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- **FEX** airport express is fastest to Hauptbahnhof (**~23 min** from Dec 2025 timetable, **ABC €5.00** from 1 Jan 2026 per [VBB](https://www.vbb.de/en/driving-information/ber-airport)).
- **S-Bahn S9** uses the same **ABC €5.00** ticket and runs every **10 min** — cheaper than older guides that quoted zone-AB only.
