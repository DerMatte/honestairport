...
sources:
  ...
  - "https://ber.berlin-airport.de/en/news/2026-05-21-anpassung-siko.html"
...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane; it can still queue when the airport opens extra Prio lanes dynamically — compare live wait times on monitors.
...
- **BER Runway ended 26 May 2026** — slot booking is discontinued; use any CT lane and follow live wait times on the BER app or terminal monitors ([BER security update](https://ber.berlin-airport.de/en/news/2026-05-21-anpassung-siko.html)).
...
- Public showers cost **€10** (towel and shampoo included, card only) on level E0 near Arrivals 2 ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- FEX airport express train is fastest to Hauptbahnhof (**€5.00** ABC ticket, **~23 min**) and runs every **15 min** until late evening ([FEX](https://www.dbregio-berlin-brandenburg.de/db-regio-no/Fahren/flughafenexpress/flughafenexpress-en)).
- S-Bahn line S9 is cheaper (**€4.00** AB ticket from 1 Jan 2026) and runs every 10 minutes ([VBB fares](https://www.vbb.de/en/tickets/single-fare-tickets/single-fare-ticket/)).
