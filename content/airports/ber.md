...
- **BER Runway ended 26 May 2026** — skip slot booking; follow live CT-lane wait times on the BER app instead of pre-booking security.
...
- Showers cost **€10** (towel and shampoo included) on **level E0** near Arrivals 2; **card only** — no cash ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- FEX airport express train is fastest to Hauptbahnhof (**~23 min**, ABC ticket **€5.00**) and runs every **15 min** ([VBB BER](https://www.vbb.de/en/driving-information/ber-airport)).
- S-Bahn line S9 uses the same **ABC €5.00** ticket and runs every **10–20 min** (slower with more stops).
