...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane — useful when CT queues spike, but still backs up at peak.
...
- **CT-first strategy:** Since BER Runway slot booking ended **26 May 2026**, pick whichever checkpoint shows the lowest wait on monitors — CT lanes often move faster than legacy X-ray lanes still on some central equipment until autumn 2026 refit.
...
- Showers cost **€10** (towel and shampoo included, card payment only) on **T1 Level E0** near luggage storage.

## Ground Transport & Parking
- **FEX** airport express is fastest to Hauptbahnhof (**~23 min**, every **15 min**) on a standard **Berlin ABC ticket (€5.00 from Jan 2026)** — no airport surcharge ([VBB BER](https://www.vbb.de/en/driving-information/ber-airport)).
- **S-Bahn S9/S45** and regional trains use the same **ABC €5.00** ticket but stop more often (~45 min to Mitte).
