...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane; on busy weekdays it can still queue when the airport opens extra Prio lanes dynamically — check live wait times on monitors.
...
- **BER Runway ended 26 May 2026** — do not book a slot; pick the shortest CT lane on live monitors instead. CT lanes allow liquids up to 2 L and packed electronics; legacy lanes still require 100 ml liquids and unpacked laptops until autumn 2026 refit. During holiday peaks, CT queues can stay under 10 minutes per official BER messaging — verify on-site.
...
- Showers cost **€10** (towel and shampoo included) on **Level E0** near Arrivals 2; **card payment only** — no cash ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).
