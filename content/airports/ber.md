...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane — show boarding pass at the marked entry.
...
- **BER Runway ended 26 May 2026:** Slot booking is discontinued — use any CT lane and check live wait times on the BER app or terminal monitors instead.
...
- Showers cost **€10** (towel and shampoo included; card payment only) on Terminal 1 arrivals level E0 ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- FEX airport express train is fastest to Hauptbahnhof (~**23 min**, ~**€9.50**) but runs only every 30 minutes.
- S-Bahn line S9 is cheaper (**€5.00** ABC Berlin ticket) and runs every 10 minutes.
