...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane separate from standard CT queues — still backs up on peak mornings; check live wait times before committing.
...
- **BER Runway ended 26 May 2026** — slot booking is discontinued; pick whichever CT lane shows the lowest wait on monitors or the BER app ([BER security update](https://ber.berlin-airport.de/en/news/2026-05-21-anpassung-siko.html)).
...
- Public showers cost **€10** (towel and shampoo included, **card only**) on **T1 level E0** near Arrivals 2 ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- FEX airport express train is fastest to Hauptbahnhof (**€5.00** ABC ticket, **~23 min** from Hbf since Dec 2025) — runs every 15 minutes until late evening ([VBB BER](https://www.vbb.de/en/driving-information/ber-airport)).
- S-Bahn S9 and regional trains use the same **ABC €5.00** fare to central Berlin and run more frequently than FEX off-peak.
