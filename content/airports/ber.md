...
- Lufthansa Group **Fast Lane** (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane — show status card and boarding pass at the marked entry.
- **BER Runway** advance security slot booking **ended 26 May 2026** ([BER security update](https://ber.berlin-airport.de/de/news/2026-05-21-anpassung-siko.html)); use live wait monitors and pick the shortest CT lane instead.
...
- **Skip paid fast track unless monitors spike:** With BER Runway gone and CT lanes open, standard checkpoints are often faster than booking third-party fast track — check the BER app before paying.
...
- Showers cost **€10** (towel + shampoo included) on **Level E0** left of Arrivals 2 — **card only**, no cash ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- **FEX** airport express is fastest to Hauptbahnhof (**~23 min**, **€5.00** Berlin ABC ticket) — runs every **15 min** ([FEX](https://www.dbregio-berlin-brandenburg.de/db-regio-no/Fahren/flughafenexpress/flughafenexpress-en)).
- **S-Bahn S9** uses the same **€5.00 ABC** ticket but is slower with more stops — every **~10–20 min** per [VBB](https://www.vbb.de/en/driving-information/ber-airport).
