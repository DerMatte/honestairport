...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane separate from standard CT queues — still check live wait times on the BER app before committing to any lane.
...
- **BER Runway ended 26 May 2026** — slot booking is discontinued; pick the shortest CT lane shown on monitors instead ([BER security update](https://ber.berlin-airport.de/de/news/2026-05-21-anpassung-siko.html)).
...
- Landside showers cost **€10** (towel and shampoo included, card only) on **Level E0** left of Arrivals 2 ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- **FEX** airport express is fastest to Hauptbahnhof (**~23 min** from Dec 2025 timetable change) but runs only every 30 minutes.
- **S-Bahn S9/S85** and regional trains use the same **ABC ticket (€5.00 since Jan 2026)** — no airport surcharge ([VBB BER guide](https://www.vbb.de/en/driving-information/ber-airport)).
