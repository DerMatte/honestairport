...
- Lufthansa Group Fast Lane (Miles & More Frequent Traveller/Senator/HON plus LH Group business/first) uses a dedicated lane; on busy mornings it can still queue when the airport opens extra Prio lanes dynamically — check live wait times on monitors or the BER app.
...
- Since CT lanes opened and **BER Runway slot booking ended 26 May 2026**, follow live wait times on the BER app or terminal monitors rather than pre-booking a security window.
...
- Showers cost **€10** (towel and shampoo included; card only) on **T1 level E0** near arrivals ([BER showers](https://ber.berlin-airport.de/en/cafes-shops-service/sgs-poi/510-duschen-t1.html)).

## Ground Transport & Parking
- FEX airport express train is fastest to Hauptbahnhof (**€5.00** Berlin ABC single, **~23 min** from Hbf) and runs every **15 min** until late evening ([FEX](https://www.dbregio-berlin-brandenburg.de/db-regio-no/Fahren/flughafenexpress/flughafenexpress-en)).
- S-Bahn lines **S9** and **S45** also reach the city on the same **Berlin ABC** fare (**€5.00** single) and run about every **10 min** at peaks.
