...
sources:
  ...
  - "https://www.bahn.de/strecke/flughafen-koeln-bonn"
quickFacts:
...
bentoTips:
  ...
  - category: "food"
    label: "Food"
    title: "Eat at Hans im Glück airside in T1"
    summary: "Best burger option is airside in T1; landside options are limited."
...
- S-Bahn line **S19** runs every 20 min to Cologne city center (**€3.50** VRS CityTicket per [bahn.de](https://www.bahn.de/strecke/flughafen-koeln-bonn)).
...
- **Book CGNGateWay** for a dedicated lane — the official free timed-slot service beats showing up blind at **06:30**.
...
- Ryanair passengers: check in online and have your boarding pass ready on your phone or printed — mobile passes are accepted when the barcode scans cleanly.
- Short-term parking P1 fills by 07:00 on weekdays; use P3 and take the free shuttle.

## Terminals & Navigation
T1 handles Eurowings, Lufthansa, and most international flights. T2 is Ryanair-heavy. **All departures clear the single central security checkpoint in T1** — T2 passengers walk over first. Walking time between furthest gates is 12 min. Follow the yellow “T1 ↔ T2” signs; moving walkways run only toward departures.
