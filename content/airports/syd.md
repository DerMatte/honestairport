...
quickFacts:
  ...
  - "Train station under T2/T3; 13 min to Central, ~$21–22 adult Opal/contactless (access fee + rail)"
  - "No TSA PreCheck equivalent; SmartGate for eligible e-passport holders"
bentoTips:
  - category: "timing"
    label: "Timing"
    title: "Arrive 3 h early for T1"
    summary: "International departures clear security fastest before 7 am and after 9 pm."
    detail: "Peak crush hits 10 am-2 pm and 6-9 pm; add 30 min if checking bags."
  - category: "terminal"
    label: "Terminal"
    title: "Use T2 for most domestics"
    summary: "T2 handles Virgin and Jetstar; T3 is Qantas only—double-check your boarding pass."
    detail: "Wrong terminal means a 20-min bus ride and possible missed flight."
  - category: "food"
    label: "Food"
    title: "Eat at T1 departures level 3"
    summary: "Bakers & Baristas and The Coffee Club open 24 h; avoid airside after security."
    detail: "Landside options are cheaper and faster if you have time before check-in."
  - category: "status"
    label: "Status"
...
> Fastest route through Sydney’s three terminals with real wait times and transfer hacks.
...
- International arrivals require 45-60 min for immigration and baggage on busy days
- T2-T3 connected by free 10-min shuttle; T1 is 1.5 km walk or short bus ride
- Train station under T2/T3; **13 min** to Central; **~$21–22** adult Opal/contactless off-peak/peak ($17.92 airport access fee + rail component) ([Transport NSW](https://transportnsw.info/travel-info/airport-travel/getting-to-from-sydney-airport))
- No TSA PreCheck equivalent; SmartGate for eligible e-passport holders
...
- Use SmartGate with e-passport to skip manual immigration queues.
- Domestic security at T2/T3 rarely exceeds 15 min except 7-9 am Monday and Friday.
- Liquids in 100 ml containers only; no PreCheck-style fast track exists.
...
- Train to Central is fastest before 7 am; after 10 pm Uber from T1 ranks is often quicker. Fare **~$21–22** adult Opal/contactless ($17.92 airport access fee + rail) ([Airport Link](https://airportlink.com.au/trip-information/price/)).
...
- T2 and T3 are 10 min apart by free shuttle; T1 requires a 5-min bus or 20-min walk.
- Domestic-to-international connection: allow 60 min minimum including security re-screen.
- Signs are clear but color-coded: red for T1, blue for T2/T3.

## Lounges, Food & Amenities
- Best paid lounge: Plaza Premium T1 (showers, quiet zones) if no airline access.
- Standout food: The Coffee Club T1 departures (24 h) and Bakers & Baristas T2 landside.
