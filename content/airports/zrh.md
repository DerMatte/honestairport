...
lounges:
  - name: "SWISS First Lounge"
    ...
    zone: "non-Schengen"
    access:
      - "SWISS/Lufthansa First Class only"
    ...
    bestFor:
      - "Relaxation"
    verdict: "worth-it"
    summary: "Among Europe's best First lounges — First Class or HON only; no day pass or Star Gold access."
...
- SWISS Business and First lounges in E dock are the best with status — **First Lounge is First Class / HON only** (no Gold, no day pass per [SWISS](https://www.swiss.com/ch/en/customer-support/faq/lounge-voucher.solo_continue)).
