...
bentoTips:
  - category: "timing"
    ...
    summary: "Security peaks 6-9am and evenings; T1 moves slower."
    detail: "Mobile boarding passes skip kiosks and shorten queues."
  - category: "terminal"
    label: "Terminal"
    title: "Confirm terminal before arrival"
    summary: "T1 for most long-haul, T2 for Ryanair and many Vueling flights."
    detail: "Free shuttle bus runs every 10 minutes between T1 and T2."
  - category: "food"
    label: "Food"
    title: "Eat landside at T1"
    summary: "Better tapas and value before security on Level 1."
    detail: "Airside options are mostly chains with higher prices."
  - category: "status"
    label: "Status"
...
> Fast, practical advice to move through Barcelona-El Prat with minimal stress and wasted time.
...
- Remove laptops and liquids at T1; T2 often allows them to stay in bags.
- Fast Track (€10-15) is worth it only before 8am or after 7pm.
- Avoid security between 6-9am and 6-9pm when queues exceed 30 minutes.
...
- For early flights, the 5:30am Aerobus from Plaça Catalunya is rarely full.
- Charge devices at T1 gates 50-60; power outlets are scarce airside.

## Terminals & Navigation
- T1 is modern and compact; most gates reachable in 10-12 minutes after security.
...
- The best quiet seating is near gates 50-60 in T1 after security.
- Paid lounges (T1) are average; skip unless you have Priority Pass.
- Free water fountains are located near most restrooms in both terminals.
