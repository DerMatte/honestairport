...
- 100 ml liquids rule strictly enforced with no exceptions for gels or creams.
- No PreCheck equivalent; use online check-in and avoid carry-on if possible during rush hours.
- Families and business-class passengers get faster lanes—use them if eligible.
- Avoid the central security zone after 20:00 when it becomes the busiest.

## Best Airport Tricks & Hacks
- Enter via the less crowded south entrance near Gate G when arriving by taxi or metro.
- Download the Istanbul Airport app for real-time gate and queue updates.
