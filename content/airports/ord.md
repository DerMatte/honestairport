...
- **MCT (same ticket, practical floor):**
  ...
  - **T5 international → T1/T2/T3:** no airside link — ATS + security; budget **90 min** minimum, **2 h** safer. **International-domestic connections require re-screening** at your departure terminal ([ORD connections](https://www.flychicago.com/ohare/en/At-the-Airport/connecting-flights)).
...
- The yoga room in **Terminal 3 Rotunda Mezzanine** is free, rarely crowded, and open **6:00 a.m.–10:00 p.m.** daily ([ORD Yoga Room](https://www.flychicago.com/ohare/ServicesAmenities/amenities/Pages/yoga.aspx)).
