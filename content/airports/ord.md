...
- Avoid the main Terminal 3 checkpoint 5–7 p.m. when possible; **Checkpoints 7A and 8** on Level 2 (with PreCheck) often move faster for Concourse K gates.
...
- The yoga room on the **Terminal 3 Rotunda Mezzanine** is free, with mats provided, **6:00 a.m.–10:00 p.m.** ([ORD yoga room](https://www.flychicago.com/ohare/ServicesAmenities/amenities/Pages/yoga.aspx)).
