...
- Terminal 5 arrivals: clear customs landside, recheck bags, then **re-clear TSA** — the ATS is landside. The airside **Terminal Transfer Bus** (Gate M13) only serves eligible same-day connections already past security.
