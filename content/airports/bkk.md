...
- **Avoid:** Booking **90 min** int'l–int'l in **January** with checked bags and an **SAT-1** departure — AOT connection guidance and peak-season queues make that a common misconnect.
