...
bentoTips:
  - category: "timing"
    ...
    summary: "Target 2 hours before domestic departure even with PreCheck."
    detail: "Security lines at B and C spike 6-8 a.m. and 4-7 p.m.; avoid those windows if possible."
  - category: "terminal"
    label: "Terminal"
  ...
  - category: "food"
    ...
    summary: "Grab chowder or lobster roll at Legal Sea Foods in Terminal C post-security."
...
> Fast, no-fluff guide to navigating Boston Logan with minimal stress and wasted time.
...
- Peak backup hits 6:30-8:30 a.m. and 4-7 p.m.; use the Massport app to pick the shortest checkpoint.
- Liquids in quart-size bags are still enforced; no exceptions at BOS.
...
- Need a quiet spot? The interfaith chapel in Terminal C (airside) is almost always empty.
...
- Legal Sea Foods (C, post-security) remains the most consistent sit-down option.
...
- Silver Line or Blue Line + Silver Line combo beats taxis for most downtown trips under $3.
- Taxi flat rate to downtown is $35-45 plus tip; rideshares often cheaper but add wait time.
- Economy parking ($18-24/day) requires a free shuttle; book Central Garage ($30-38/day) if you want to walk.
