...
quickFacts:
  ...
  - "T5 closed Oct 2025 until ~2028; JetBlue at T1, Spirit check-in at T2 (gates MSC South)"
  - "TSA PreCheck at T1, T4, T6, T7, and TBIT South; CLEAR at T1, T3, T4, T6, T7, and TBIT"
bentoTips:
  - category: "timing"
    label: "Timing"
...
- **South cluster (T4–T8):** **T4** (American), **T5** (closed for rebuild until ~2028), **T6** (Alaska, Air Canada, Hawaiian), **T7–T8** (United). **Spirit** uses **T2** for check-in with gates at **MSC South** (airside bus). Connected airside via tunnels and walkways; **TBIT** links via skybridge to **T4**.
