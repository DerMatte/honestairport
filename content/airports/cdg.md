...
quickFacts:
  ...
  - "RER B to Paris 35–50 min (Ticket Paris Région <> Aéroports €14 from Jan 2026); avoid rush hour if possible"
...
- **2G schedule trap:** **N2** runs on a **fixed schedule** between **2F and 2G only** — missing a shuttle is a common misconnect; pad **20+ min**.
...
- **RER B tickets:** **€14** adult one-way (**Ticket Paris Région <> Aéroports**, valid Jan 2026+) — load onto **Navigo Easy**, the Île-de-France Mobilités app, or a mobile wallet; no disposable paper ticket ([Île-de-France Mobilités](https://www.iledefrance-mobilites.fr/)).
...
- **Best value:** **RER B** to central Paris — **35–50 min**, **€14** one-way airport ticket — avoid **07:00–09:00** and **17:00–19:00** crush.
