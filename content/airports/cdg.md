...
quickFacts:
  ...
  - "RER B to Paris 35–50 min (~€14); digital/Navigo Easy only from Jan 2026"
...
- **Within T2:** **N1 bus** (2A/2C ↔ 2B/2D ↔ 2E ↔ 2F, 24/7), **N2 bus** (**2F ↔ 2G only** — **2G has no CDGVAL**).
...
- **2A/2B/2C/2D → 2E/2F:** Take **N1** instead of walking when time is tight — walking can exceed **15–20 min**.
- **2G schedule trap:** **N2** runs **2F ↔ 2G** on a fixed schedule (every **~8 min**, **05:30–23:00**) — missing a shuttle is a common misconnect; pad **20+ min**.
...
- **RER B tickets:** **€14** adult one-way (**Ticket Paris Région <> Aéroports**) — load onto **Navigo Easy**, the Île-de-France Mobilités app, or Apple Wallet; **no paper ticket** from Jan 2026 ([RATP](https://www.ratp.fr/en/titres-et-tarifs/ticket-paris-region-aeroports)).
