...
- **SkyLine:** Free automated train **T1 ↔ T3** every **~2–3 min**, ride **8–10 min** ([FRA Terminal 3](https://www.frankfurt-airport.com/en/flights-and-transfer/terminal-3.html)). Operates **04:00–23:00**; **overnight shuttle bus** between terminals outside those hours. **Walking between terminals is not practical.**
...
- **Rail insider:** **S8/S9** to Frankfurt Hbf every **15 min** (~**€6.90** city↔airport single; [RMV](https://www.rmv.de/c/en/tickets/your-ticket/tickets-overview/single-tickets/single-ticket)); **ICE** long-distance from **Fernbahnhof** (T1 lower level) — book at [bahn.de](https://www.bahn.de/) to skip counter queues.
