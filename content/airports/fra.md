...
quickFacts:
  ...
  - "SkyLine links T1 and T3 04:00–23:00 (shuttle bus overnight); 8–10 min ride"
...
- **SkyLine:** Free automated train **T1 ↔ T3** every **~2 min**, ride **8–10 min** ([FRA Terminal 3](https://www.frankfurt-airport.com/en/flights-and-transfer/terminal-3.html)). Operates **04:00–23:00**; **overnight shuttle bus** between terminals **23:00–04:00** during ongoing inspections. **Walking between terminals is not practical.**
...
- **Fastest to Frankfurt center:** **S8/S9** to Hauptbahnhof (**10–15 min**, ~**€6.90** city↔airport single); runs frequently until ~**01:00** (overnight T1↔T3 use shuttle bus, not SkyLine).
