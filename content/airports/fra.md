...
quickFacts:
  ...
  - "SkyLine links T1 and T3 in 8–10 min; suspended nightly 23:00–04:00 (shuttle bus substitute)"
  - "Lufthansa/Star Alliance hub; T3 has CT security with 2 L liquids allowed"
  - "S8/S9 S-Bahn to Frankfurt Hbf in 10–15 min (city↔airport single €6.90); ICE from Fernbahnhof T1"
...
- **SkyLine:** Free automated train **T1 ↔ T3** every **~2 min**, ride **8–10 min** ([FRA Terminal 3](https://www.frankfurt-airport.com/en/flights-and-transfer/terminal-3.html)). **Suspended nightly 23:00–04:00** for track inspections — shuttle buses replace it until further notice ([Fraport](https://www.fraport.com/en/newsroom/press-releases/2026/q2/new-sky-line-people-mover-now-running-again.html)). **Walking between terminals is not practical.**
