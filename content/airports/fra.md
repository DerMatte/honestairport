...
- **SkyLine:** Free automated train **T1 ↔ T3** every **~2 min**, ride **8–10 min** ([FRA Terminal 3](https://www.frankfurt-airport.com/en/flights-and-transfer/terminal-3.html)). Runs **04:00–23:00** daily; **shuttle buses** cover terminals **23:00–04:00** during nightly maintenance ([Fraport SkyLine update](https://www.fraport.com/en/newsroom/press-releases/2026/q2/new-sky-line-people-mover-now-running-again.html)). **Walking between terminals is not practical.**
...
- **Rail insider:** **S8/S9** to Frankfurt Hbf every **15 min** (~**€6.90** airport↔city single, RMV zones 5090↔5000); **ICE** long-distance from **Fernbahnhof** (T1 lower level) — book at [bahn.de](https://www.bahn.de/) to skip counter queues.
...
- [RMV airport↔city fares](https://www.rmv.de/c/en/tickets/your-ticket/tickets-overview/single-tickets/single-ticket)
- [SkyLine operating update (Fraport)](https://www.fraport.com/en/newsroom/press-releases/2026/q2/new-sky-line-people-mover-now-running-again.html)
