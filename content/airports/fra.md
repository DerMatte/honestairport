...
quickFacts:
  ...
  - "S8/S9 S-Bahn to Frankfurt Hbf in 10–15 min (~€6.90); ICE from Fernbahnhof T1"
...
- **SkyLine:** Free automated train **T1 ↔ T3** every **~2–3 min**, ride **8–10 min** ([FRA Terminal 3](https://www.frankfurt-airport.com/en/flights-and-transfer/terminal-3.html)). Operates **04:00–23:00**; **overnight shuttle buses** replace it **23:00–04:00**. **Walking between terminals is not practical.**
...
- **Rail insider:** **S8/S9** to Frankfurt Hbf every **15 min** (~**€6.90** city↔airport single per [RMV](https://www.rmv.de/)); **ICE** long-distance from **Fernbahnhof** (T1 lower level) — book at [bahn.de](https://www.bahn.de/) to skip counter queues.
...
- [RMV fares (city ↔ airport)](https://www.rmv.de/)
- Re-check terminal assignment (T1 vs T3) before every trip — the Jun 2026 T2→T3 migration is still settling. SkyLine runs 04:00–23:00; use overnight shuttle buses outside those hours.
