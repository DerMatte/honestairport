...
bentoTips:
  ...
  - category: "status"
    ...
    summary: "All terminals completed CT rollout Jan 2026 — 2 L liquids allowed at connection security."
...
- **Liquids on connections:** All terminals (**T2–T5 including T4**) completed CT scanner rollout **24 Jan 2026** — liquids in containers **up to 2 litres** and large electronics may stay in cabin baggage at connection security ([Heathrow hand baggage](https://www.heathrow.com/at-the-airport/security-and-baggage/hand-baggage-and-liquids)).
...
- **Liquids at connection security:** All terminals use the same **2-litre container** rule at CT-equipped connection checkpoints — follow on-site signage if staff route you to a legacy lane.
...
- **Separate-ticket self-transfer:** Treat it like an airport change — immigration, baggage, terminal hop, new check-in. BA recommends **at least 4 hours** for separate tickets; experienced travelers treat **3–4 hours** as the practical floor, not airline MCT marketing.
...
- **Airside:** Use purple Flight Connections buses between terminals — don’t try to “walk it” between distant terminals airside.
...
- **Water:** Refill stations exist airside in newer areas — bring an empty bottle; bottled water is expensive (typical airport markup).
- **Power:** T5 upper levels and many gate areas have USB outlets, but competition is fierce during delays — charge early if you see an open seat.

## Ground Transport & Parking
- **Fastest to central London:** Heathrow Express (~15 min to Paddington) — premium pricing; buy at machines before boarding to avoid on-train surcharges.
- **Best value:** **Elizabeth line** to central/West End (cheaper than Express; check TfL fares for your destination).
- **Budget:** Piccadilly line — slowest but cheapest; good for late/early when you’re not in a rush.
- **Inter-terminal landside:** Free via Heathrow Express/Elizabeth between terminals; buses also run landside if trains are awkward with heavy bags.
- **Parking:** Short-stay is punishingly expensive — book long-stay or off-site in advance for multi-day trips.
- **Coaches:** National Express and other coaches depart from the central bus station between T2/T3.
