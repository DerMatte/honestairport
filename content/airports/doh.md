...
quickFacts:
  ...
  - "Arrive at least 3 h before departure; economy check-in opens 3 h before and closes 1 h before"
...
bentoTips:
  - category: "timing"
    label: "Timing"
    title: "Arrive 3 h early"
    summary: "Security queues peak 2.5–3 h before departure; clear the checkpoint first."
    detail: "Avoid the 18:00–22:00 rush when multiple long-haul banks depart together."
  - category: "terminal"
    label: "Transfers"
    title: "Use the internal train"
    summary: "Ride the free people-mover between concourses instead of walking 15+ min."
...
- Use biometric e-gates if you hold a GCC, UK, EU, US, or Australian passport.
- Liquids in 100 ml containers only; no PreCheck equivalent.
- Families and business-class passengers get dedicated lanes—look for the yellow signs.
...
- One terminal; all arrivals and departures on the same level.
- Internal train runs every 3–5 min between concourses; 4–7 min ride end-to-end.
- Walking time from security to farthest gate (D) is 12–15 min; use the moving walkways.
...
- https://www.dohaairport.com/
- https://www.dohaairport.com/en/security
- https://www.dohaairport.com/en/ground-transportation
- https://www.qr.com (Qatar Airways flight status)
