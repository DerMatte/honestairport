...
quickFacts:
  ...
  - "CATSA security; NEXUS dedicated lanes; YYZ Express virtual queuing"
  - "UP Express reaches Union Station in 28 minutes"
  - "YYZ Express free virtual security queuing; NEXUS dedicated lanes"
...
bentoTips:
  ...
  - category: "status"
    ...
    detail: "Lines can swing 15-60 minutes; NEXUS and YYZ Express reservations skip the worst queues."
lounges:
...
- CATSA manages security; **NEXUS** dedicated lanes in both terminals; **YYZ Express** offers free virtual security reservations ([YYZ Express](https://www.torontopearson.com/en/departures/yyz-express)).
- UP Express train departs every 15 minutes and reaches Union Station in **28 minutes** ([UP Express](https://www.upexpress.com/en/up-express-stations/pearson-station/departures-and-schedules)).
...
- Book a free **YYZ Express** security slot up to 72 hours ahead during eligible hours — reduces wait unpredictability.
...
- UP Express is fastest and most reliable to downtown (**$12.35** one-way, **$9.25** with PRESTO; **28 min** to Union).
