...
quickFacts:
  ...
  - "CATSA security; NEXUS available — no CLEAR Plus lanes (YYZ Express virtual queue instead)"
...
bentoTips:
  ...
  - category: "status"
    ...
    detail: "Lines can swing 15-60 minutes; NEXUS users and YYZ Express reservations skip the worst queues."
lounges:
...
- CATSA manages security; NEXUS lanes exist in both terminals. **CLEAR Plus is not at YYZ** — use free **YYZ Express** virtual queuing instead ([Pearson UP Express](https://www.torontopearson.com/en/transportation-and-parking/up-express)).
- UP Express train departs every 15 minutes and reaches Union Station in **28 minutes**.
...
- NEXUS members should head straight to dedicated lanes in T1 or T3; book **YYZ Express** for a free security time slot when available.
...
- UP Express is fastest and most reliable to downtown (**$12.35** one-way, **$9.25** with PRESTO).
