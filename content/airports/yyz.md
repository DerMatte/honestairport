...
sources:
  ...
  - "https://www.newswire.ca/news-releases/introducing-yyz-express-a-new-program-to-book-your-security-spot-in-line-ahead-of-time-814022199.html"
quickFacts:
  - "Two terminals (T1 and T3) linked by free Link Train (5 min)"
  - "Air Canada hub; WestJet and Porter also major"
  - "CATSA security; NEXUS available; YYZ Express for free virtual security queuing"
...
bentoTips:
  ...
  - category: "status"
    ...
    detail: "Lines can swing 15-60 minutes; NEXUS members and YYZ Express users skip the worst queues."
lounges:
...
- CATSA manages security; **NEXUS** dedicated lanes exist in both terminals. **YYZ Express** offers free virtual security queuing — not CLEAR Plus membership lanes.
- UP Express train departs every 15 minutes and reaches Union Station in **28 minutes** ($12.35 / $9.25 PRESTO).
...
- NEXUS members should head straight to their dedicated lanes in T1 or T3; book **YYZ Express** online for a free security time slot during peaks.
