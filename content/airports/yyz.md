...
sources:
  ...
  - "https://ir.clearme.com/news-events/press-releases/detail/59/copenhagen-optimization-clear-launch-free-virtual-queuing"
quickFacts:
  - "Two terminals (T1 and T3) linked by free Link Train (5 min)"
  - "Air Canada hub; WestJet and Porter also major"
  - "CATSA security; NEXUS available; YYZ Express virtual queue (not CLEAR Plus lanes)"
...
bentoTips:
  - category: "timing"
    ...
    summary: "International departures need the full buffer."
  ...
  - category: "food"
    ...
    summary: "Best sit-down options sit past security in T1."
    detail: "Avoid landside food courts; post-security choices are fresher and less crowded."
  - category: "status"
    label: "Live checks"
    title: "Check CATSA wait times"
    summary: "Use the airport app before leaving home."
    detail: "Lines can swing 15-60 minutes; NEXUS users skip the worst queues. Book free YYZ Express slots online up to 72 h ahead."
lounges:
...
- CATSA manages security; NEXUS lanes exist in both terminals. **YYZ Express** (free virtual queue powered by CLEAR) replaces dedicated CLEAR Plus lanes — book a security slot online up to **72 h** ahead.
- UP Express train departs every 15 minutes and reaches Union Station in **28 minutes** ([UP Express](https://www.upexpress.com/)).
...
- Book **YYZ Express** for a free reserved security window when you are not using NEXUS — slots open up to **72 h** before departure.
- NEXUS members should head straight to dedicated lanes in T1 or T3.
...
- Pre-clear U.S. customs at YYZ for flights to the States to skip lines on arrival.
- Walk the moving walkways in T1 to reach the far gates faster than waiting for the train.
...
- Air Canada Maple Leaf Lounge in T1 offers showers and hot food for eligible passengers.
- T1 post-security has the strongest food selection: sit-down spots in Concourse F.
- T3 has fewer quality options; grab coffee at the Starbucks near gate C32 if needed.
- Quiet zones with charging ports exist near gates A22 and F22 in T1.

## Ground Transport & Parking
- UP Express is fastest and most reliable to downtown (**$12.35** one-way, **$9.25** with PRESTO; **28 min** to Union) ([Pearson UP Express](https://www.torontopearson.com/en/transportation-and-parking/up-express)).
