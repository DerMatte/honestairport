...
- **T2 ↔ T3:** No airside connection — use the free landside shuttle (10–15 min) and budget **90+ min** for immigration, baggage, and re-check on separate tickets.
...
- T1 and T2 are adjacent with an indoor walkway; **T3 is 2 km away via landside shuttle only** — no airside T2↔T3 link.
