...
quickFacts:
  - "Three terminals: T3 (Air China, Star Alliance, most oneworld international), T2 (SkyTeam)"
  - "T3 is the largest and handles most long-haul international flights"
...
bentoTips:
  ...
  - category: "terminal"
    ...
    detail: "No airside link between T2 and T3—use the landside shuttle only."
  - category: "food"
    label: "Food & quiet"
...
- T3 handles Air China, Star Alliance, and most oneworld international flights; T2 serves SkyTeam.
...
- No airside link between T2 and T3—always use the landside shuttle when connecting.
...
- T1-T2 are adjacent; T3 is 2 km away via landside shuttle.
- No airside connection between T2 and T3; shuttle only.
