...
bentoTips:
  ...
  - category: "terminal"
    label: "Transfers"
    title: "T2↔T3 is landside only"
    summary: "Free shuttle buses run every 10 minutes but add 15-20 min plus re-security."
    detail: "There is no airside walkway between T2 and T3 — budget 90 min+ for connections."
  - category: "food"
    label: "Food & quiet"
...
- **MCT (same ticket):** **90 min** T2↔T3 minimum including **landside shuttle** and re-security; **2 h** safer.
...
- Use the **landside T2–T3 shuttle** for terminal changes — there is no airside walkway.
...
- T1-T2 are adjacent; T3 is **2 km away** via landside shuttle only.
- T2↔T3 transfers require exiting security, riding the shuttle (~10–15 min), and re-clearing checks.
