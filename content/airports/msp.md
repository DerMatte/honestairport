...
bentoTips:
  - category: "timing"
    ...
    summary: "Domestic flights rarely need more than 90 minutes at MSP outside rush hours."
    detail: "Add 30 minutes during 6–9 a.m. and 4–7 p.m. peaks or when carrying skis or bikes."
  - category: "terminal"
    label: "Terminal"
  ...
  - category: "food"
    ...
    summary: "Best quick options sit between gates C4–C12 before security crowds hit."
    detail: "Avoid post-security food in Terminal 2 after 8 p.m.; most spots close early."
  - category: "status"
    label: "Status"
...
> MSP rewards travelers who know the two-terminal layout and avoid the two daily rush windows.
...
- Avoid the main Terminal 1 checkpoint 6–9 a.m. and 4–7 p.m.; use the C concourse checkpoint instead when open.
- Families and oversized bags create the longest backups—use the far-left lanes.
...
- Solid quick meals: Ramen at Ramen Takara (C12) and burgers at The Cove (Terminal 1).
- Quietest seating is near gate C21 or the upper level of the G concourse after 8 p.m.

## Ground Transport & Parking
- Light rail is the fastest downtown option at $2.50; runs every 10–15 minutes.
- Rideshares pick up on the lower level of Terminal 1; expect 10–20 minute waits during peaks.
- Short-term parking costs $3 for the first 30 minutes; long-term economy is $14/day with free shuttle.

## Official Sources
- https://www.mspairport.com/
- https://www.tsa.gov/airports/minneapolis-saint-paul-international-airport
- https://www.mspairport.com/parking-transportation
