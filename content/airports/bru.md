...
bentoTips:
  - category: "timing"
    label: "Timing"
    title: "Arrive 90 min early for Schengen"
    summary: "Target 90 minutes before departure for EU flights."
    detail: "Add 30 minutes for non-Schengen or peak 7-9 am rush."
  - category: "terminal"
    label: "Terminal"
    title: "Check your pier before security"
    summary: "A, B or C pier is printed on your boarding pass."
    detail: "Wrong pier means backtracking after security; signs are clear but slow."
  - category: "food"
    label: "Food"
    title: "Eat before security on level 0"
    summary: "Better value and seating at level 0 cafés."
    detail: "Post-security options are limited and overpriced after 8 pm."
  - category: "status"
    label: "Status"
...
> One terminal, fast train links and predictable security make BRU easy once you know the pier system.
...
- Arrive with liquids already in a clear 100 ml bag; no PreCheck equivalent exists.
- Peak rush hits 6:30-9:00 am and 5:00-7:00 pm; use the online wait-time display on the airport site.
- Families and passengers with reduced mobility get dedicated lanes at the far left.
- Keep passport and boarding pass ready; random additional checks occur after metal detectors.

## Best Airport Tricks & Hacks
- Download the Brussels Airport app before arrival for live gate and delay alerts.
...
- One terminal only; follow overhead signs for piers A (Schengen), B (mixed) or C (non-Schengen).
- End-to-end walk from security to farthest gate takes 20-25 minutes at normal pace.
- Moving walkways run only in piers B and C; pier A requires full walking.
- Common mistake: entering security too early for a C-pier flight and then facing a long trek.

## Lounges, Food & Amenities
- Brussels Airlines Lounge in pier B is the best paid option (€45 day pass) with hot food and showers.
...
- Taxi to city centre costs €45-55 and takes 25-40 min depending on traffic.
- Short-term parking P1/P2 is €4 per hour; long-term P3/P4 drops to €12 per day after day 3.
- Book P-Relais online for cheapest long-stay rates and free shuttle every 15 minutes.
