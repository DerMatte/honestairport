...
sources:
  ...
  - "https://www.portseattle.org/sea-tac/parking"
quickFacts:
  - "Alaska Airlines primary hub; Delta secondary hub"
  - "Single terminal with Concourses A, B, C, D"
  - "Link light rail reaches downtown in 35-40 minutes"
  - "TSA PreCheck and CLEAR lanes available"
  - "International arrivals must re-clear security for connections"
bentoTips:
  - category: "timing"
    label: "Timing"
    title: "Arrive 2 hours early"
    summary: "Security peaks 6:30-9am and 4-7pm on weekdays."
    detail: "Skip the buffer only on late-evening Alaska flights when lines drop fast."
  - category: "terminal"
    label: "Transfers"
    title: "Ride the tram first"
    summary: "Take the free tram from main terminal to Concourse D before walking."
    detail: "Works best for A-to-D connections; avoid during peak if you have heavy bags."
  - category: "food"
    label: "Food & quiet"
    title: "Eat post-security before your gate"
    summary: "Ivar's in the Central Terminal; Beecher's at Concourse C near C3; ramen at C2."
    detail: "All airside — clear security first. Best when your gate is in C or D; allow time for the tram if departing from A or B."
  - category: "status"
    label: "Live checks"
...
lounges:
  - name: "The Club at SEA"
    ...
    bestFor:
      - "Work"
    verdict: "depends"
    summary: "Worth a visit with free Priority Pass access; also available in the South Satellite (Concourse S)."
...
> SEA rewards travelers who know the tram, light rail, and exact security peaks.
...
- Standard lanes back up fastest 6:30-9am and 4-7pm; avoid those windows if possible.
- Families and oversized bags create the longest backups at the central checkpoint.
- Global Entry kiosks are upstairs near baggage claim for arrivals.
...
- Eat post-security at **Ivar's** in the Central Terminal, **Beecher's** at Concourse C (C3), or the ramen shop at **C2** on the way to C or D gates.
...
- Grab a free umbrella at the information desk near baggage claim on rainy days.

## Terminals & Navigation
- Everything funnels through one terminal; the tram is the fastest way to reach Concourse D.
- Walking time from security to farthest gate (D14) is about 12 minutes with the tram.
- A-to-D connections require the tram plus a short walk; budget 15 minutes minimum.
- Common mistake: following signs for "Gates" instead of the tram when heading to D.

## Lounges, Food & Amenities
- **The Club at SEA** has locations in **Concourse A** (opposite A11) and the **South Satellite** (near S9); both accept Priority Pass but fill by mid-morning.
- Best quick food: **Ivar's** fish & chips (Central Terminal, post-security), **Beecher's** at Concourse C (C3), or the ramen shop at C2.
...
- Garage General Parking is **$32/day** (hourly $5, capped daily); Reserved Floor 4 is $39/day.
