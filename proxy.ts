 ...
 *
 * x402 charging for lounge / airport-tab markdown lives on the `/md` route
 * handler (`withX402`), not here — HTML, free airport `.md`, and discovery
 * markdown must keep passing through.
 */
